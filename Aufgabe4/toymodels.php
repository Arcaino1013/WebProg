...
<html lang="de">
  ...
  <body>
    <header>
      <nav>
        <ul>
          <li><a href="cart.php"><i class="fas fa-shopping-cart"></i>Warenkorb<!-- HIER MÜSSEN SIE CODE ERGÄNZEN (Warenkorbzähler)! --></a></li>
        </ul>
      </nav>
    ...
    <footer><p>This page is copyright &copy; 2020 by the Toymodels GmbH</p></footer>
  </body>
</html>
